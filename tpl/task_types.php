...
<tr>
	...
	<form action="
        <?php echo $tpl->url('task_types', 'action', 'update', 'id', $type->id) ?>"
        method="POST">
            <td>
            ...
            <td colspan="2">
                ...
                <a href="<?php echo $tpl->url('task_types') ?>">
	...
	<?php else: ?>
        ...
        <td <?php if ($type->refs !== '0') echo 'colspan="2"'; ?>>
            <a href="<?php echo $tpl->url('task_types', 'action', 'edit', 'id', $type->id) ?>">
        ...
        <?php if ($type->refs === '0'): ?>
            ...
            <a onclick="return confirm('<?php echo $tpl->getLang('js')['remove_confirm'] ?>')"
                href="<?php echo $tpl->url('task_types', 'action', 'remove', 'id', $type->id) ?>">
...
<form action="<?php echo $tpl->url('task_types', 'action', 'add') ?>" method="POST">
<tr>
